...
const plans = [
  {
    ...
    features: [
      ...
      "3rd-Party Calendar Sync (Google, Outlook)",
  ...
  },
  {
    ...
    price: "59.99",
    description: "Best for busy professionals & small teams",
    features: [
      "All Personal features PLUS: Up to 10 Team Seats",
      "Advanced Contextual Scheduling",
      "CRM & Project Tool Integration",
      "Priority support",
      "Priority Email & Chat Support",
      "API access",
      "Mobile app",
      "Custom Tone/Voice Profiles",
      "50GB Cloud Storage",
    ],
    mostPopular: true,
  },
  {
    name: "Enterprise",
    price: "199.99",
    description: "For large organizations & high-volume use. Custom Pricing. All Professional features PLUS",
    features: [
